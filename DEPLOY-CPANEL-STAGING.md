...
- Database: SQLite at `/home/complextravel/public_html/intranet_staging/intranet.db` — separate file from
...
- Backups: ensure `~/public_html/intranet_staging/intranet.db` is covered by cPanel backups or a cron copy.
