...
const GOOGLE_DRIVE_URL = 'https://drive.google.com/drive/u/0/folders/0APl1pjYySvczUk9PVA'

const GoogleDriveMark: React.FC<{ size?: number }> = ({ size = 16 }) => (
